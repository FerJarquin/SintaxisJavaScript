function condicionales(valor) {
    if (valor.length === 0) {
        alert("La caja de texto esta vacía")
    } else {
        alert("La caja de texto no esta vacía y su contenido es: " + valor)
    }
}
...
llamar:
nombreFuncion(parametros o argumentos);

tambien se puede de la siguiente forma:
definir:

const nombreFuncion = function(parasmetros o argumentos){

}

llamar:
var nombreVariable = nombreFuncion(parametros o argumentos)
*/
